Public Class frmempsalarystructure
    ...
    End Sub
    Sub total()
        txttotal.Text = Val(TextBox10oa1.Text) + Val(TextBox11oa2.Text) + Val(TextBox13daamt.Text) + Val(TextBox14hraamt.Text) + Val(TextBox15ccaamt.Text) + Val(TextBox16pfamt.Text) + Val(TextBox17educeaseamt.Text) + Val(TextBox4basic.Text)
    End Sub
