...
Public Class CR_salary_sheet_t
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.CR_salary_sheet_t.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_salary_sheet_t
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_salary_sheet_t = New CR_salary_sheet_t()
        rpt.Site = Me.Site
        Return rpt
    End Function
