...
Public Class Rptentrytaxshort
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.Rptentrytaxshort.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptentrytaxshort
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rptentrytaxshort = New Rptentrytaxshort()
        rpt.Site = Me.Site
        Return rpt
    End Function
