...
Public Class CrSalMonthly2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.CrSalMonthly2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSalMonthly2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSalMonthly2 = New CrSalMonthly2()
        rpt.Site = Me.Site
        Return rpt
    End Function
