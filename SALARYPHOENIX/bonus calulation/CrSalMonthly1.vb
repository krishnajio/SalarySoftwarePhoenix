...
Public Class CrSalMonthly1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.CrSalMonthly1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSalMonthly1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSalMonthly1 = New CrSalMonthly1()
        rpt.Site = Me.Site
        Return rpt
    End Function
