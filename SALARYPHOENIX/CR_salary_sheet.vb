...
Public Class CR_salary_sheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.CR_salary_sheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_salary_sheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_salary_sheet = New CR_salary_sheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
