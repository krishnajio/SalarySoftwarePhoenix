...
Public Class MDIParent1
    ...
    Private Sub MansarSalaryToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub SALARYACCORDINGTOMOTHDDAYSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SALARYACCORDINGTOMOTHDDAYSToolStripMenuItem.Click
        Dim t As New frmempsal_acc_to_mothdays
        t.ShowDialog()
    End Sub
    ...
    Private Sub SALARYSTATEMENTToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles SALARYSTATEMENTToolStripMenuItem1.Click
        Dim sal As New phxrptshow
        sal.Show()
    End Sub

    Private Sub BANKLAISTToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BANKLAISTToolStripMenuItem.Click
        Dim bank As New bankstateshow
        bank.Show()
    End Sub

    Private Sub SALARYTRANSFERToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SALARYTRANSFERToolStripMenuItem.Click
        Dim salt As New FrmEmpSalTransfer
        salt.ShowDialog()
    End Sub

    Private Sub SALARYTRANSERTOACCToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SALARYTRANSERTOACCToolStripMenuItem.Click
        Dim salt As New FrmEmpSalTransfer
        salt.ShowDialog()
    End Sub
