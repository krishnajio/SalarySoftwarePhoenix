...
Public Class CR_salary_slipold
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.CR_salary_slipold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_salary_slipold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_salary_slipold = New CR_salary_slipold()
        rpt.Site = Me.Site
        Return rpt
    End Function
