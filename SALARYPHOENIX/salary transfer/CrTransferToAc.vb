...
Public Class CrTransferToAc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.CrTransferToAc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrTransferToAc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrTransferToAc = New CrTransferToAc()
        rpt.Site = Me.Site
        Return rpt
    End Function
