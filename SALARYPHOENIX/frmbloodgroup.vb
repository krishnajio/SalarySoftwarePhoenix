Public Class frmbloodgroup

    Private Sub frmbloodgroup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        fillgrid()
    End Sub
    Private Sub fillgrid()
        Try
            ...
            DataGridView1.DataSource = ds.Tables("bg")
    ...
    Private Sub Button1save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1save.Click
        Dim sql As String
        sql = "insert into bloodgroup values('" & TextBox1.Text & "')"
    ...
    Private Sub Button2upd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2upd.Click
        Dim sql As String
        sql = "delete from bloodgroup where bloodgroup = '" & TextBox1.Text & "'"
        globalmod.SqlExecuteNonQuery(sql)
        fillgrid()
    End Sub
