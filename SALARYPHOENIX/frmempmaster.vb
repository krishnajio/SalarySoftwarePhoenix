Public Class frmempmaster
    ...
    Private Sub ComboBox2dep_Leave(sender As Object, e As EventArgs) Handles ComboBox2dep.Leave
        Button1save.Focus()
    End Sub
    ...
    Private Sub DateTimePicker1dob_Leave(sender As Object, e As EventArgs) Handles DateTimePicker1dob.Leave
        ComboBox1org.Focus()
    End Sub
    ...
    Private Sub DateTimePicker1dob_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePicker1dob.ValueChanged
