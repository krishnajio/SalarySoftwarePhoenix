...
Public Class phxsalrptother
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.phxsalrptother.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedphxsalrptother
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As phxsalrptother = New phxsalrptother()
        rpt.Site = Me.Site
        Return rpt
    End Function
