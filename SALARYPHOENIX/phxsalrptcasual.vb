...
Public Class phxsalrptcasual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SALARYPHOENIX.phxsalrptcasual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedphxsalrptcasual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As phxsalrptcasual = New phxsalrptcasual()
        rpt.Site = Me.Site
        Return rpt
    End Function
