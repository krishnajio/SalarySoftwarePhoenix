Public Class frmempsalaryentry
        ...
        Try
            ...
            If globalmod.ds.Tables("tbgetacc").Rows(0)(0) = "" Then
                sqlinsert = "insert into empsalarytemp(orgid, empid, salmonth," _
                        ...
                        & " userid, groupinsded, secudep, od1,paymode,UID,UIdCode,isfund,esibit) values('" & organization & "','" _
                        & empid & "','" & setmonth & "','" _
                        ...
                        & secdep & "','" & otded & "','CASH','" & ds.Tables("empinfo").Rows(0)("UID") & "','" & ds.Tables("empinfo").Rows(0)("UIdCode") & "','" & ds.Tables("empinfo").Rows(0)("is_pen_fund") & "','" & ds.Tables("empinfo").Rows(0)("esibit") & "')"
            ...
            Else
                ...
                sqlinsert = "insert into empsalarytemp(orgid, empid, salmonth," _
                         ...
                         & proftax & "','" & loan_amt & "','0','','" & pf833 & "','" _
                         & pf367 & "',1, '" & globalmod.soft_username & "','" & grpin & "','" _
                         & secdep & "','" & otded & "','BANK','" & ds.Tables("empinfo").Rows(0)("UID") & "','" & ds.Tables("empinfo").Rows(0)("UIdCode") & "','" & ds.Tables("empinfo").Rows(0)("is_pen_fund") & "','" & ds.Tables("empinfo").Rows(0)("esibit") & "')"
                globalmod.SqlExecuteNonQuery(sqlinsert)
            End If
    ...
    Private Sub Button3savechanges_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3savechanges.Click
        ...
        globalmod.SqlExecuteNonQuery(sql)
        ' globalmod.SqlExecuteNonQuery(" exec [esicalc] '" & organization & "','" & TextBox1empid.Text & "','" & setmonth & "'")
        TextBox1empid.Focus()
    ...
    Public Sub CalacESI()
        ...
        total = Val(TextBox1amttopay.Text) + Val(TextBox1da.Text) + Val(TextBox3cca.Text) + Val(TextBox2hra.Text)
        ' MsgBox(total.ToString())

        If total < 4250 Then
            TextBox6oa1.Text = "0"
            TextBox1secdepo.Text = Math.Ceiling(total * 0.0475)
            TextBox7oa2.Text = Math.Ceiling(Val(TextBox7oa2.Text) - (total * 0.0175))

        Else
            TextBox6oa1.Text = Math.Round(total * 0.0175)
            TextBox1secdepo.Text = Math.Round(total * 0.065)
        End If
    End Sub
